...
<center><img src="{{URL('storage/email/breakdown'.rand(1,2).'.png')}}" style="width:35%" alt="Status Logo"></center><br>
...
Please <a href="mailto:{{$data['depot_email']}}">contact us</a> if you need to make any changes to this booking.
